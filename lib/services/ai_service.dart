...
class AIService {
  ...
  Future<String> createRoutine({
    ...
    try {
      ...
      String minoxText = usesMinoxidil ? "Sí usa Minoxidil" : "No usa Minoxidil";
      ...
      final prompt = Content.text('''
        ...
        3. Sé motivador, usa un tono de "Coach" o "Hermano mayor". Usa emojis.
        4. Dame la respuesta en texto plano pero bien estructurado con viñetas.
        5. No uses Markdown complejo (negritas simples están bien).
      ''');

      // 4. Enviamos y esperamos respuesta
      final response = await model.generateContent([prompt]);

      return response.text ?? "Hubo un error generando tu rutina, bro. Intenta de nuevo.";
    } catch (e) {
